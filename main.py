...
#### TASK A ####
    ...
    #Train and evaluate the CNN for Task A

    trainCNNA(data_path_A)

    # Test with pretrained model
    #test_trained_model_A(model_path_A, data_path_A)
...
#### TASK B ####
    ...
    #trainCNNB(data_path_B)

    #test_trained_model_B (model_path_B, data_path_B)
